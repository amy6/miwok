...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView numbersList = findViewById(R.id.numbers);
        final TextView colorsList = findViewById(R.id.colors);
        final TextView familyList = findViewById(R.id.family);
        final TextView phrasesList = findViewById(R.id.phrases);
